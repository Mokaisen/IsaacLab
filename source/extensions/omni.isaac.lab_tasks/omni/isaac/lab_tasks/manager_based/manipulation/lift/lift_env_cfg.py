...
class EventCfg:
    ...
    reset_object_position = EventTerm(
        func=mdp.biased_reset_root_state_uniform,
        mode="reset",
        params={
...
class RewardsCfg:
    ...
    reaching_object = RewTerm(func=mdp.object_ee_distance, params={"std": 1.0}, weight=2.6)

    lifting_object = RewTerm(func=mdp.object_is_lifted, params={"minimal_height": 0.04}, weight=3.0)
...
class LiftEnvCfg(ManagerBasedRLEnvCfg):
    ...
    scene: ObjectTableSceneCfg = ObjectTableSceneCfg(num_envs=2, env_spacing=2.5)
    # Basic settings
